...
$config['des_key'] = 'ZKtjIN2BJxCq764g1OIGsFfO';
...
// For example %n = mail.domain.tld, %t = domain.tld
$config['username_domain'] = 'devtest.com';

// ----------------------------------
// PLUGINS
// ----------------------------------
// List of active plugins (in plugins/ directory)
$config['plugins'] = array('attachment_reminder', 'database_attachments', 'filesystem_attachments', 'help', 'identity_select', 'newmail_notifier', 'password', 'save_pdf', 'userinfo', 'virtuser_query', 'zipdownload');
...
// %d - domain (http hostname $_SERVER['HTTP_HOST'] without the first part)
// %z - IMAP domain (IMAP hostname without the first part)
$config['password_db_dsn'] = '%h - mysql://localhost'; //by done aliax
...
$config['hmailserver_remote_dcom'] = true;//done by aliax
// Windows credentials
$config['hmailserver_server'] = array(
    'Server'   => 'localhost',      // hostname or ip address
    'Username' => 'mermaid',  // windows username
    'Password' => 'mermaidkks321'        // windows user password
);
