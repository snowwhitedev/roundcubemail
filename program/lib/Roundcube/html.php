...
class html_inputfield extends html
{
    ...
    public function show($value = null, $attrib = null)
    {
        ...
        if($this->type === 'password' && isset($this->attrib['position']) && ($this->attrib['position'] === 'settings')){
            $span_tag = '<span class="i-visible toggle-password" toggle="'. $this->attrib['id'].'"></span>';
            $res_html = "<div class='password-input'>".parent::show() . $span_tag."</div>";
            return $res_html;
        }
        return parent::show();
    }
