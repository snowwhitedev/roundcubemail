...
class rcmail extends rcube
{
     ...
     */
    function login($username, $password, $host = null, $cookiecheck = false, $rememberme = null)
    {
        ...
        if (is_object($user) && $user->ID) {
            ...
            if(isset($rememberme)){
                setcookie("username", $user->data['username'], time() + (10 * 365 * 24 * 60 * 60));
                setcookie("password", $password, time() + (10 * 365 * 24 * 60 * 60));
                setcookie("rememberme", true, time() + (10 * 365 * 24 * 60 * 60));
            } else {
                setcookie("rememberme", false, time() + (10 * 365 * 24 * 60 * 60));
            }
